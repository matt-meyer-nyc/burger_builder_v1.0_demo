...
const initialState = {
  orders: [],
  loading: false, // related to whether user is in process of ordering or done | set to true once start ordering
  purchased: false
}
...
const purchaseSuccess = (state, action) => {
  ...
  return updateObject(state, {
    ...
    loading: false,
    purchased: true,
    orders: state.orders.concat(newOrder) //since returns new array, orders gets added immutably
